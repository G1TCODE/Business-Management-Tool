...
namespace BMT.Infrastructure.Migrations
{
    ...
    [Migration("20230921173349_Create_Database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BMT.Domain.Locations.Store", b =>
                {
                    b.OwnsOne("BMT.Domain.Shared.Address", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("BMT.Domain.Orders.Item", b =>
                {
                    ...
                    b.OwnsOne("BMT.Domain.Shared.Money", "Price", b1 =>
                        {
            ...
            modelBuilder.Entity("BMT.Domain.Products.Product", b =>
                {
                    b.OwnsOne("BMT.Domain.Shared.Money", "UnitPrice", b1 =>
                        {
                    ...
                    b.OwnsOne("BMT.Domain.Shared.Name", "Name", b1 =>
                        {
                            b1.Property<Guid>("ProductId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BMT.Domain.Shopping_Cart.ShoppingCart", b =>
                {
                    b.OwnsOne("BMT.Domain.Shared.Money", "ShoppingCartTotal", b1 =>
                        {
                    ...
                    b.OwnsOne("System.Collections.Generic.List<BMT.Domain.Orders.Item>", "TheShoppingCart", b1 =>
                        {
                            b1.Property<Guid>("ShoppingCartId")
                                .HasColumnType("uniqueidentifier");
